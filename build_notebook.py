...
# target 노트북 파일 경로
target_file_path = 'MLfinal1_v1.ipynb'

with open(target_file_path, 'w', encoding='utf-8') as f:
    json.dump(notebook_data, f, ensure_ascii=False, indent=1)

print("SUCCESS: MLfinal1_v1.ipynb has been generated cleanly!")
